...
import 'package:food_trans/home/view/item_filter.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      Item(id: '1', name: 'Laptop', category: 'Tech', description: '', imageUrl: ''),
      Item(id: '2', name: 'Shirt', category: 'Fashion', description: '', imageUrl: ''),
      Item(id: '3', name: 'Smartwatch', category: 'Tech', description: '', imageUrl: ''),
      Item(id: '4', name: 'Vitamins', category: 'Health', description: '', imageUrl: ''),
      Item(id: '5', name: 'Jeans', category: 'Fashion', description: '', imageUrl: ''),
    ];

    return Scaffold(
      body: BlocProvider(
        create: (_) => ItemFilterCubit(items),
        child: Column(
          children: [
            Container(
              height: 200,
